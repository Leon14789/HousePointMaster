     ...
     <div class="container">
         <div class="row align-items-center">
             <div class="col-lg-7 py-5">
                 <h1 class="mb-4">Ranking da Gincana ETEC Professor Elias Miguel Junior</h1>
                 <h2 class="m-0">Acompanhe a pontuação das turmas e veja quem está liderando a competição!</h2>
             </div>
             <div class="col-lg-5">
                             ...
                             <div class="card border-0 border-bottom-red shadow-lg shadow-hover">
                                 <div class="card-body text-center">
                                     <div class="text-center">
                                         <i class="fa fa-book fa-4x my-2"></i>
                                     </div>
                                     REGRAS
                                 </div>
                             </div>
                     ...
                     <div class="d-flex">
                         ...
                         <a href="#" class="w-50 pl-3">
                             <div class="card border-0 border-bottom-green shadow-lg shadow-hover">
                                 <div class="card-body text-center">
                                     <div class="text-center">
                                         <i class="fa fa-envelope fa-4x fa-list my-2"></i>
                                     </div>
                                     Recursos
                                 </div>
                             </div>
